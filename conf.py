...
project = 'Discover Credit Card Activation'
...
html_title = "How to Activate Your Discover Credit Card – discover.com/activate Guide"
html_short_title = "discover.com/activate"
